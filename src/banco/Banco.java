    ...
    public static Connection iniciarConexao() {
        if(conexao == null){
            try{
                ...
                JOptionPane.showMessageDialog(null, "======== CONEX�O INICIADA ========");
            }catch (Exception e1){
            	JOptionPane.showMessageDialog(null, "N�o foi poss�vel se conectar a base de dados");
    ...
    public static void fecharConexao() {
        if(conexao != null){
            try{
                ...
                JOptionPane.showMessageDialog(null, "N�o foi poss�vel ao fechar a conex�o com a base de dados");
